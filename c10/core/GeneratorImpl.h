...
struct C10_API GeneratorImpl : public c10::intrusive_ptr_target {
  ...
  virtual void set_current_tensor_seed(c10::intrusive_ptr<c10::TensorImpl> seed) {
    TORCH_CHECK(false, "set_current_tensor_seed is not implemented for this generator");
  }
